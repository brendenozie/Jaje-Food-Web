export default function Footer() {
  return (
    // <!-- component -->bg-gradient-to-r from-gray-100 via-[#ffd2bc] to-gray-100
<footer className="">
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <img src="/loo.png" className="mr-5 h-6 sm:h-9" alt="logo" />
        <p className="max-w-xs mt-4 text-sm text-gray-100 uppercase">
          The best in town
        </p>
